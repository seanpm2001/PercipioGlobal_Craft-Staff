...
class VariantGdis
{
    public static function fill(?int $variantId, Request $request): BenefitVariantGdis
    {
        $benefit = BenefitVariantGdis::findOne($variantId);

        if (is_null($benefit)) {
            $benefit = new BenefitVariantGdis();
