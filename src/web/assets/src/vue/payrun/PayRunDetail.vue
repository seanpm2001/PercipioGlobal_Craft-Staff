...
<template>
    ...
    <div class="flex">
        <div class="sm:flex-auto" style="margin-bottom:0">
            ...
            <p class="mt-2 text-sm text-gray-700">A list of all the pay runs of.</p>
        </div>
        <div class="mt-4 flex items-top" style="margin-bottom:0">
    ...
    <div class="mt-8 flex">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none" style="margin-bottom:0">
            <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Download latest Pay Run Entries Template</button>
        </div>
    </div>      
</template>