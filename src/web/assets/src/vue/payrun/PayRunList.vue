...
<template>
    ...
    <div class="md:flex">
        <div class="flex-grow pr-4" style="margin-bottom:0">
            ...
            <p class="mt-2 text-sm text-gray-700">Click on a pay run to upload the CSV with the pay run entries. If the pay run is not provided in the list bellow, use the "Fetch&nbsp;Pay&pnbs;Runs" button on your right to fetch.</p>
        </div>
        ...
        <div class="-my-2 overflow-x-auto w-full">
            <div class="inline-block min-w-full py-2 align-middle">
                <div class="overflow-hidden shadow border border-solid border-gray-300 md:rounded-lg">
                    ...
                    <!-- HEADINGS -->
                    <div class="grid grid-cols-5 lg:grid-cols-9 border-b border-solid border-gray-300">
                        ...
                        <div class="text-center lg:text-left px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Import status</div>
